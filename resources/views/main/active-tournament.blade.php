<div class="text-center mt-20 mb-20 flex items-center justify-center gap-2">
    <p class="text-4xl main-text font-bold">Torneo activo</p>
...
<div class="m-2 flex flex-col items-center active-tournament-border rounded-xl p-2 w-fit mx-auto">
    ...
    <p class="mt-5 mb-5 text-center text-2xl main-text transition-all duration-300"><a href="" class="main-link font-bold transition-all duration-300">Ver tabla</a> del partido</p>
</div>
