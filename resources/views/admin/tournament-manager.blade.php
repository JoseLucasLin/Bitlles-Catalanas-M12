...
<main class="flex-1 ms-10 me-10">
    ...
    <div class="bg-[var(--crema)] p-6 shadow-xl rounded-lg border-[var(--azul)] border">
        <h3 class="text-lg font-semibold text-[var(--azul)] mb-4">Seleccionar Torneo</h3>
    ...
    <div class="mt-6 bg-[var(--crema)] p-6 shadow-xl rounded-lg border-[var(--azul)] border">
        <h3 class="text-lg font-semibold text-[var(--azul)] mb-4">Información del Torneo</h3>
        <p class="text-sm text-gray-600"><strong>Pistas Disponibles:</strong> 5</p>
        <p class="text-sm text-gray-600"><strong>Jugadores Inscritos:</strong> 32</p>
