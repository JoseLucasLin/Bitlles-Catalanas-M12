...
<main class="flex-1 ms-10 me-10">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="bg-[var(--crema)] p-4 shadow-xl rounded-lg border-[var(--azul)] border">
            ...
            <div class="mt-2 flex justify-start">
                <button disabled class="mt-2 bg-gray-400 text-[var(--blanco)] p-2 pe-4 rounded font-bold flex items-center justify-center space-x-2 opacity-75">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
        ...
        <div class="bg-[var(--crema)] p-4 shadow-xl rounded-lg border-[var(--azul)] border">
            ...
            <div class="mt-2 flex justify-start">
                <a href="#" class="mt-2 bg-gray-400 text-[var(--blanco)] p-2 pe-4 rounded font-bold flex items-center justify-center space-x-2 cursor-not-allowed opacity-75 pointer-events-none">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
        ...
        <div class="bg-[var(--crema)] p-4 shadow-xl rounded-lg border-[var(--azul)] border">
            ...
            <div class="mt-2 flex justify-start">
                <a href="{{ route('admin.player-search') }}" class="mt-2 bg-[var(--rojo)] text-[var(--blanco)] p-2 pe-4 rounded transition duration-300 hover:bg-[var(--azul)] font-bold hover:scale-105 flex items-center justify-center space-x-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
        ...
        <div class="bg-[var(--crema)] p-4 shadow-xl rounded-lg border-[var(--azul)] border">
            <h3 class="text-lg font-semibold text-[var(--azul)]">{{ __('admin.distribute_players') }}</h3>
            <p class="text-sm text-gray-600">{{ __('admin.distribute_players_desc') }}</p>
            <div class="mt-2 flex justify-start">
                <a href="{{ route('admin.players-fields') }}" class="mt-2 bg-[var(--rojo)] text-[var(--blanco)] p-2 pe-4 rounded transition duration-300 hover:bg-[var(--azul)] font-bold hover:scale-105 flex items-center justify-center space-x-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
                      </svg>                      
                    <span>{{ __('admin.distribute') }}</span>
                </a>
            </div>
        </div>
