...
<main class="flex-1 ms-10 me-10">
    ...
    <form action="{{ route('registro.store') }}" method="POST" enctype="multipart/form-data" class="max-w-xl mx-auto">
        ...
        <!-- Name -->
        <div class="mb-4">
            <x-input-label for="username" :value="__('Username')"  class="block text-lg font-medium text-[var(--azul)]"/>
            <x-text-input id="username"  type="text" name="username" :value="old('username')" class="mt-2 p-2 w-full border border-[var(--azul)] rounded bg-[var(--crema)]" required placeholder="Escribe el nombre de usuario" autofocus autocomplete="name" />
        ...
        <!-- Email Address -->
        <div class="mt-4">
            <x-input-label for="email" :value="__('Correo electrónico')"  class="block text-lg font-medium text-[var(--azul)]"/>
            <x-text-input id="email" type="email" class="mt-2 p-2 w-full border border-[var(--azul)] rounded bg-[var(--crema)]"  type="email" name="email" :value="old('email')" required placeholder="ejemplo@correo.com" autocomplete="username" />
        ...
        <div class="mb-4 relative">
            <x-input-label for="password" class="block text-lg font-medium text-[var(--azul)]" :value="__('Contraseña')" />
        ...
        <!-- Confirm Password -->
        <div class="mb-4 relative">
            <x-input-label for="password_confirmation" class="block text-lg font-medium text-[var(--azul)]" :value="__('Confirm Password')" />
    
            <x-text-input id="password_confirmation" class="block mt-1 w-full"
                            type="password"
                            name="password_confirmation" class="mt-2 p-2 w-full border border-[var(--azul)] rounded bg-[var(--crema)] pr-10" required placeholder="Repite la contraseña" autocomplete="new-password" />
