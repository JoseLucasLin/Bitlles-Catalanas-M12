            ...
            <div class="flex items-center space-x-2">
                ...
                @guest
                    ...
                    <div class="md:hidden flex gap-2">
                        ...
                        <a class="text-white p-2 transition-all duration-300 rounded-lg font-semibold text-sm bg-[var(--azul)] hover:bg-[var(--rojo)] flex items-center" href="{{ route('player.acces') }}">
                ...
                <div class="hidden md:flex md:items-center gap-2">
                    ...
                    <a class="text-white p-3 transition-all duration-300 rounded-lg font-semibold text-lg bg-[var(--azul)] hover:bg-[var(--rojo)] flex items-center" href="{{ route('player.acces') }}">
